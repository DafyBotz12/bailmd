...
case 'tiktok2': {
                ...
                m.reply(mess.wait)
                let anu = await fetchJson(`https://api.lolhuman.xyz/api/tiktok?apikey=GuraHentai095&url=https://vt.tiktok.com/ZSwWCk5o/`)
                hisoka.sendMessage(m.chat, { video: { url: anu.result.link }, caption:  ⚜️ *Nickname*: {anu.result.author.nickname}\n❤️ *Like*: {anu.result.statistic.diggCount}\n💬 *Komentar*: {anu.result.statistic.commentCount}\n🔁 *Share*: {anu.result.statistic.shareCount}\n🎞️ *Views*: {anu.result.statistic.playCount}\n?? *Desc*: {anu.result.title}, contextInfo: { mentionedJid: [m.sender] } }, { quoted: m })
            }
            break
            case 'chat': {
            ...
            case 'join': {
                ...
                await hisoka.acceptInvite(result).then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
            }
            break
            case 'leave': {
...
if (args.length == 0) return m.reply(`Example: ${prefix + command} Yogyakarta`)
  daerah = args.join(" ")
get_result = await fetchJson(`https://api.lolhuman.xyz/api/sholat/${daerah}?apikey=GuraHentai095`)
...
/*case 'nulis':
        case 'tulis':
               if (args.length < 1) return m.reply('Yang mau di tulis apaan?titid?')
               teks = args.join(' ')
               m.reply(mess.wait)
               ...
               hisoka.sendMessage(m.chat, buff, image, {quoted: m, caption: mess.success}).catch(e => {
...
case 'alquran':
                    ...
                    urls = `http://api.lolhuman.xyz/api/quran/${args[0]}?apikey=GuraHentai095`
...
│
│⭔ \`\`\`${prefix}linkgroup\`\`\`
│⭔ \`\`\`${prefix}ephemeral\`\`\` _<[option]>_
│⭔ \`\`\`${prefix}setpp\`\`\`
│⭔ \`\`\`${prefix}setname\`\`\`  _<[text]>_
│⭔ \`\`\`${prefix}group\`\`\`  _<[option]>_
│⭔ \`\`\`${prefix}add\`\`\` _<@user>_
│⭔ ${asep}${prefix}kick${asep}  _<@user>_
│⭔ ${asep}${prefix}promote${asep}  _<@user>_
│⭔ ${asep}${prefix}demote${asep}  _<@user>_
│
└───────⭓

┌──⭓ *🔍Search Menu🔍*
│
│⭔ ${asep}${prefix}pinterest${asep}
│⭔ ${asep}${prefix}wallpaper${asep}
│⭔ ${asep}${prefix}wikimedia${asep}
│
└───────⭓

┌──⭓ *💕Random Menu💕*
│
│⭔ ${asep}🔞${prefix}porno${asep}
│⭔ ${asep}${prefix}hentai${asep}
│⭔ ${asep}${prefix}quotesanime${asep}
│
└───────⭓

┌──⭓ *🏂Main Menu🏂*
│
│⭔ ${asep}${prefix}ping${asep}
│⭔ ${asep}${prefix}owner${asep}
│⭔ ${asep}${prefix}menu / ${prefix}help / ${prefix}?${asep}
│⭔ ${asep}${prefix}delete${asep}
│
└───────⭓

┌──⭓ *👤Owner Menu👤*
│
│⭔ ${asep}${prefix}chat${asep}  _<[option]>_
│⭔ ${asep}${prefix}join${asep}  _<[link]>_
│⭔ ${asep}${prefix}leave${asep}
│⭔ ${asep}${prefix}block${asep}  _<@user>_
│⭔ ${asep}${prefix}unblock${asep}  _<@user>_
│
└───────⭓

┌──⭓ *🕌Islam Menu*
│
│⭔ ${asep}${prefix}jadwalsholat${asep}  _<daerah>_
│⭔ ${asep}${prefix}alquran${asep}  _<query>_
│⭔ ${asep}${prefix}kisahnabi${asep}  _<query>_
│⭔ ${asep}${prefix}asmaulhusna${asep}
│
└───────⭓
`
